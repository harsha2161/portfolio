        ...
        <div id="projucts" className="w-full px-[5%] sm:px-[10%] lg:px-[12%] py-20 scroll-mt-15">
            ...
            <div className="grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] my-10 gap-5">
                ...
                <a href={project.link} key={index}>
                    ...
                    cursor-pointer group border-2" key={index} style={{backgroundImage : `url(${project.bgImage})`}}>
            ...
            <a href="#projucts" className="w-max flex items-center justify-center gap-2 text-gray-700 border-[0.5px] border-gray-700 rounded-full py-3 px-10 
            mx-auto hover:bg-lightHover dark:text-white dark:border-white dark:hover:bg-darkHover">Show more {isDarkMode?<FaLocationArrow />:<FaLocationArrow/>}</a>
        </div>
    )
}
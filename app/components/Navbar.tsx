...
export default function Navbar({ isDarkMode, setDarkMode }: any){
    ...
    return (
        ...
        <nav className={`w-full fixed top-0 px-4 py-4 lg:px-8 xl:px-[8%] flex items-center justify-between z-50 transition-all duration-300
            ...
            <ul ref={sideMenuRef} className='flex md:hidden flex-col gap-4 py-20 px-10 fixed -right-64 top-0 bottom-0 w-64 z-50 h-screen bg-rose-50 dark:bg-darkHover dark:text-white transition duration-500'>
